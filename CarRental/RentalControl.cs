...
public partial class RentalControl : UserControl
{
    ...
    private void LoadAvailableVehicles()
    {
        ...
        dgvAvailable.DefaultCellStyle.BackColor = Color.FromArgb(22, 22, 32);
        dgvAvailable.DefaultCellStyle.ForeColor = Color.FromArgb(220, 220, 220);
        dgvAvailable.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(18, 18, 28);
        dgvAvailable.AlternatingRowsDefaultCellStyle.ForeColor = Color.FromArgb(220, 220, 220);
    ...
    private void btnSelect_Click(object sender, EventArgs e)
    {
        ...
        row.DefaultCellStyle.BackColor = AppTheme.PurpleLight;
        UpdateSummary();
    }
    ...
    private void btnConfirm_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            db.CreateRental(rentalID, ssn, selectedVehicleID, paymentID, startDate, endDate, cost);
