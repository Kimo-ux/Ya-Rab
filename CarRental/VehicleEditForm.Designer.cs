...
partial class VehicleEditForm
{
    ...
    private void InitializeComponent()
    {
        ...
        lblVehicleID.ForeColor = Color.FromArgb(124, 58, 237);
        ...
        lblFamily.ForeColor = Color.FromArgb(124, 58, 237);
        ...
        lblType.ForeColor = Color.FromArgb(124, 58, 237);
        ...
        lblYear.ForeColor = Color.FromArgb(124, 58, 237);
        ...
        lblColour.ForeColor = Color.FromArgb(124, 58, 237);
        ...
        lblOrigin.ForeColor = Color.FromArgb(124, 58, 237);
        ...
        lblPlate.ForeColor = Color.FromArgb(124, 58, 237);
        ...
        lblRate.ForeColor = Color.FromArgb(124, 58, 237);
        ...
        lblSupplier.ForeColor = Color.FromArgb(124, 58, 237);
        lblSupplier.Location = new Point(3, 510);
        lblSupplier.Name = "lblSupplier";
        lblSupplier.Padding = new Padding(0, 0, 9, 0);
        lblSupplier.Size = new Size(194, 51);
        ...
        cmbSupplier.Location = new Point(203, 518);
        ...
        pnlButtons.Location = new Point(18, 562);
